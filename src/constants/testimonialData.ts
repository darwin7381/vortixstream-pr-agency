export const testimonials = [
  ...
  {
    quote: "Their strategic approach to AI PR positioning helped us stand out in a crowded market. The media coverage exceeded all expectations.",
    name: "Emily Watson",
  ...
  {
    quote: "The team's expertise in DeFi marketing helped us reach the right investors at the perfect time. Truly exceptional service and results.",
    name: "Sarah Chen",
  ...
  {
    quote: "Outstanding work on our Web3 gaming platform launch. Their understanding of both gaming and crypto audiences is unmatched.",
    name: "Jordan Taylor",
    title: "CEO at GameChain Interactive"
  }
];