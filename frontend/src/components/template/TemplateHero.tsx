      ...
      <div className="relative z-10 container-large px-[17px] md:px-0">
        <div className="text-center max-w-content-xlarge mx-auto">
          ...
          >
            ...
            <span className="text-white/80 text-sm font-medium">Professional PR Templates</span>
          </div>
          ...
          >
            ...
            <span className="block mt-2">
              ...
              >
                Empowering Anyone to Craft Professional News
              </span>
            </span>
          </h1>
          ...
          >
            Professionally crafted PR templates for product launches, funding announcements, awards, and more. 
            No PR experience needed—download and customize, or preview our upcoming AI-powered generator.
          </p>
          ...
          >
            {[
              { value: '8+', label: 'Template Types' },
              { value: '5,000+', label: 'Downloads' },
              { value: '100%', label: 'Free to Use' },
              { value: 'AI', label: 'Coming Soon' }
            ].map((stat, index) => (
              <div 
                key={index}
