...
export default function ClientLogosSection() {
  ...
  return (
    <section ref={sectionRef} className="relative bg-[#191919] py-12 md:py-20 overflow-hidden">
      ...
      <div className="absolute inset-0">
        {[...Array(12)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-white rounded-full opacity-8"
            style={{
      ...
      {/* Dynamic Radial Accents */}
      <div 
        className="absolute inset-0 opacity-40"
        style={{
          background: `
            radial-gradient(circle at 15% 25%, rgba(255, 116, 0, 0.04) 0%, transparent 50%),
            radial-gradient(circle at 85% 75%, rgba(29, 53, 87, 0.06) 0%, transparent 50%),
            radial-gradient(circle at 50% 50%, rgba(255, 116, 0, 0.02) 0%, transparent 60%)
          `
        }}
      />

      <div className="relative z-10 px-4 sm:px-5 lg:px-16">
