import svgPaths from "./svg-633do1do15";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}
      >
        <p className="block leading-[1.5]">5 Guaranteed Press Release</p>
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}
      >
        <p className="block leading-[1.5]">Same-day delivery</p>
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}
      >
        <p className="block leading-[1.5]">Editorial recommendations</p>
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}
      >
        <p className="block leading-[1.5]">Dedicated Support Team</p>
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}
      >
        <p className="block leading-[1.5]">SEO Optimization Included</p>
      </div>
    </div>
  );
}
...
function Content3() {
  return (
    ...
    >
      <div
        className="font-['Noto_Sans:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#ffffff] text-[16px] text-left w-full"
        style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}
      >
        <p className="block leading-[1.5]">Includes:</p>
      </div>
      <List />
    </div>
  );
...
function Column1() {
  return (
    <div
      className="basis-0 bg-[#000000] grow min-h-px min-w-px relative rounded-2xl self-stretch shrink-0"
      data-name="Column"
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-between p-[32px] relative size-full">
          <Content4 />
          <Actions1 />
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}
      >
        <p className="block leading-[1.5]">10 Guaranteed Press Release</p>
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}
      >
        <p className="block leading-[1.5]">30 Guaranteed Press Release</p>
      </div>
    </div>
  );
}
...
function Column3() {
  return (
    <div
      className="basis-0 bg-[#000000] grow min-h-px min-w-px relative rounded-2xl shrink-0"
      data-name="Column"
    >
      <div
        aria-hidden="true"
...
function Radio1() {
  return (
    ...
    >
      <Radio />
      <div
        className="flex flex-col font-['Noto_Sans:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#ffffff] text-[16px] text-left text-nowrap"
        style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100" }}
      >
...
function Contact2() {
  return (
    ...
    >
      <div className="flex flex-col items-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-12 items-center justify-start px-16 py-28 relative w-full">
          <Container4 />
        </div>
      </div>
    </div>
...
function Content19() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-4 items-start justify-start leading-[0] p-0 relative shrink-0 text-[#ffffff] text-left w-full"
      data-name="Content"
    >
      <div className="font-['Space_Grotesk:Medium',_sans-serif] font-medium relative shrink-0 text-[36px] tracking-[-0.36px] w-full">
...
function Card() {
  return (
    <div
      className="basis-0 bg-[#00000080] bg-[position:0%_0%,_50%_50%] bg-size-[auto,cover] grow min-h-px min-w-px relative rounded-2xl self-stretch shrink-0"
      data-name="Card"
      style={{ backgroundImage: `url('${imgCard}')` }}
    >
      <div className="flex flex-col justify-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-6 items-start justify-center p-[32px] relative size-full">
          <ContentTop />
          <Actions4 />
        </div>
      </div>
