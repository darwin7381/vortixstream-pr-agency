...
from ..models.pricing import PricingPackageCreate, PricingPackageUpdate, PricingPackage

router = APIRouter(prefix="/pricing")


@router.get("/packages/by-id/{package_id}", response_model=PricingPackage)
async def get_pricing_package_by_id(package_id: int):
